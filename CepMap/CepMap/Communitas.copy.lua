...
if Locale.GetCurrentLanguage().DisplayName == "Español" then
	-- Spanish/Español
		COMMUNITAS_NAME = "Communitas"
		COMMUNITAS_DESCRIPTION = "Crea continentes e islas, con climas basadas en la elevación y el viento. Incluye opciones de configuración para los juegos personalizados."
		COMMUNITAS_PLAYERS_START = "Ubicaciones de inicio"
		COMMUNITAS_CONTINENTS = "Continentes - dondequiera"
		COMMUNITAS_TERRA = "Terra - el continente más extenso"
		COMMUNITAS_OCEAN_RIFT = "Rifts oceánicos"
		COMMUNITAS_PACIFIC_ATLANTIC = "El Pacífico y el Atlántico"
		COMMUNITAS_ATLANTIC = "2 Atlánticos"
		COMMUNITAS_PACIFIC = "2 Pacíficos"
		COMMUNITAS_2RANDOM = "2 al azar"
		COMMUNITAS_1RANDOM = "1 al azar"
		COMMUNITAS_NO_RIFT = "Ningunos"
		COMMUNITAS_RIFT_WIDTH = "Ancho de rifts"
		COMMUNITAS_NARROW_RIFT = "Angosto"
		COMMUNITAS_STANDARD_RIFT = "Estándar"
		COMMUNITAS_WIDE_RIFT = "Amplio"
else	
	-- English/English
		COMMUNITAS_NAME = "Communitas"
		COMMUNITAS_DESCRIPTION = "Creates continents and islands, with climate based on elevation and wind. Includes custom game setup options."
		COMMUNITAS_PLAYERS_START = "Players Start"
		COMMUNITAS_CONTINENTS = "Continents - Everywhere"
		COMMUNITAS_TERRA = "Terra - Largest Continent"
		COMMUNITAS_OCEAN_RIFT = "Ocean Rifts"
		COMMUNITAS_PACIFIC_ATLANTIC = "Pacific and Atlantic"
		COMMUNITAS_ATLANTIC = "2 Atlantic"
		COMMUNITAS_PACIFIC = "2 Pacific"
		COMMUNITAS_2RANDOM = "2 Random"
		COMMUNITAS_1RANDOM = "1 Random"
		COMMUNITAS_NO_RIFT = "None"
		COMMUNITAS_RIFT_WIDTH = "Rift Width"
		COMMUNITAS_NARROW_RIFT = "Narrow"
		COMMUNITAS_STANDARD_RIFT = "Standard"
		COMMUNITAS_WIDE_RIFT = "Wide"
end
