...
function OnFounderBeliefClick()
	...
	if(ToggleBeliefContext("FounderBelief")) then
		...
		--modchange
		table.sort(availableFounderBeliefs, function(a,b) return ModLocale.ComparePriority(a, b); end);
...
function OnFollowerBeliefClick()
	...
	if(ToggleBeliefContext("FollowerBelief")) then
		...
		--modchange
		table.sort(availableFollowerBeliefs, function(a,b) return ModLocale.ComparePriority(a, b); end);
...
function OnEnhancerBeliefClick()
	...
	if(ToggleBeliefContext("EnhancerBelief")) then
		...
		-- Sort by their description.
		--modchange
		table.sort(availableEnhancerBeliefs, function(a,b) return ModLocale.ComparePriority(a, b); end);
...
function OnBonusBeliefClick()
	...
	if(ToggleBeliefContext("BonusBelief")) then
		...
		-- Sort by their description.
		--modchange
		table.sort(availableBonusBeliefs, function(a,b) return ModLocale.ComparePriority(a, b); end);
