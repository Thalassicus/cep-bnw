...
local ModVersion	= nil
local ModUserData	= nil
if Modding then
...
function UpdateGameOptionsDisplay()
	...
	if Controls.AutosaveMinutesEdit then
		Controls.AutosaveMinutesEdit:SetText( MapModData and MapModData.AutosaveMinutes or "" );
	end
    Controls.AutosaveTurnsEdit:SetText( MapModData and MapModData.AutosaveTurns or OptionsManager.GetTurnsBetweenAutosave_Cached() );
...
----------------------------------------------------------------
----------------------------------------------------------------
function OnAutosaveMinutesChanged( string )
	if MapModData then
		MapModData.AutosaveMinutes = string
		ModUserData.SetValue("Civup_AutoSaveMinutes", string)
	end
end
if Controls.AutosaveMinutesEdit then
	Controls.AutosaveMinutesEdit:RegisterCallback( OnAutosaveMinutesChanged );
end
...
function OnAutosaveTurnsChanged( string )
	if MapModData then
		MapModData.AutosaveTurns = string
		ModUserData.SetValue("Civup_AutoSaveTurns", string)
	else
