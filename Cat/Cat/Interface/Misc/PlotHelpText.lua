...
-- Cope: [ REPRESENT ] Add unit popup on mouseover		
		local strUnits = GetUnitsString(plot);
		if (strUnits ~= "") then
			TextString = TextString .. strUnits;
			TextString = TextString .. "[NEWLINE]";
		end
----------
		-- Resource
	...
	if (TextString ~= "") then
--AttilaMod+
--Do not display bottom right plot mouseover text
