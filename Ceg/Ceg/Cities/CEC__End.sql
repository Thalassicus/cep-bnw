...
DELETE FROM Buildings							WHERE Type IN ('BUILDING_RECYCLING_CENTER', 'BUILDING_BOMB_SHELTER', 'BUILDING_NOTRE_DAME', 'BUILDING_BOROBUDUR', 'BUILDING_PRORA');
DELETE FROM Building_BuildingClassHappiness		WHERE BuildingType IN ('BUILDING_RECYCLING_CENTER', 'BUILDING_BOMB_SHELTER', 'BUILDING_NOTRE_DAME', 'BUILDING_BOROBUDUR', 'BUILDING_PRORA');
DELETE FROM Building_BuildingClassYieldChanges	WHERE BuildingType IN ('BUILDING_RECYCLING_CENTER', 'BUILDING_BOMB_SHELTER', 'BUILDING_NOTRE_DAME', 'BUILDING_BOROBUDUR', 'BUILDING_PRORA');
DELETE FROM Building_FreeUnits					WHERE BuildingType IN ('BUILDING_RECYCLING_CENTER', 'BUILDING_BOMB_SHELTER', 'BUILDING_NOTRE_DAME', 'BUILDING_BOROBUDUR', 'BUILDING_PRORA');
DELETE FROM Building_ResourceQuantity			WHERE BuildingType IN ('BUILDING_RECYCLING_CENTER', 'BUILDING_BOMB_SHELTER', 'BUILDING_NOTRE_DAME', 'BUILDING_BOROBUDUR', 'BUILDING_PRORA');
DELETE FROM Building_YieldChanges 				WHERE BuildingType IN ('BUILDING_RECYCLING_CENTER', 'BUILDING_BOMB_SHELTER', 'BUILDING_NOTRE_DAME', 'BUILDING_BOROBUDUR', 'BUILDING_PRORA');
