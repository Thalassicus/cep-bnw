...
UPDATE Units SET PrereqTech='TECH_OPTICS'                   WHERE UnitClass='UNITCLASS_CARGO_SHIP';
UPDATE Units SET PrereqTech='TECH_CARVEL_HULLS'             WHERE UnitClass='UNITCLASS_CARAVEL';
UPDATE Units SET PrereqTech='TECH_CARVEL_HULLS'             WHERE UnitClass='UNITCLASS_GALLEASS';
UPDATE Units SET PrereqTech='TECH_MINING'                   WHERE UnitClass='UNITCLASS_SENTINEL';
UPDATE Units SET PrereqTech='TECH_MATHEMATICS'              WHERE UnitClass='UNITCLASS_COMPOSITE_BOWMAN';
UPDATE Units SET PrereqTech='TECH_METAL_CASTING'            WHERE UnitClass='UNITCLASS_PIKEMAN';
UPDATE Units SET PrereqTech='TECH_BIOLOGY'                  WHERE UnitClass='UNITCLASS_CONSCRIPT';
UPDATE Units SET PrereqTech='TECH_STEAM_POWER'              WHERE UnitClass='UNITCLASS_GATLINGGUN';
UPDATE Units SET PrereqTech='TECH_INDUSTRIALIZATION'        WHERE UnitClass='UNITCLASS_GREAT_WAR_INFANTRY';
UPDATE Units SET PrereqTech='TECH_INDUSTRIALIZATION'        WHERE UnitClass='UNITCLASS_IRONCLAD';
UPDATE Units SET PrereqTech='TECH_RAILROAD'                 WHERE UnitClass='UNITCLASS_WWI_TANK';
UPDATE Units SET PrereqTech='TECH_COMBUSTION'               WHERE UnitClass='UNITCLASS_ANTI_AIRCRAFT_GUN';
UPDATE Units SET PrereqTech='TECH_COMBUSTION'               WHERE UnitClass='UNITCLASS_ANTI_TANK_GUN';
UPDATE Units SET PrereqTech='TECH_COMBUSTION'               WHERE UnitClass='UNITCLASS_BATTLESHIP';
UPDATE Units SET PrereqTech='TECH_COMPUTERS'                WHERE UnitClass='UNITCLASS_BAZOOKA';
UPDATE Units SET PrereqTech='TECH_COMBINED_ARMS'            WHERE UnitClass='UNITCLASS_BOMBER';
UPDATE Units SET PrereqTech='TECH_COMBUSTION'               WHERE UnitClass='UNITCLASS_CARRIER';
UPDATE Units SET PrereqTech='TECH_REFRIGERATION'            WHERE UnitClass='UNITCLASS_DESTROYER';
UPDATE Units SET PrereqTech='TECH_COMBINED_ARMS'            WHERE UnitClass='UNITCLASS_FIGHTER';
UPDATE Units SET PrereqTech='TECH_ROCKETRY'                 WHERE UnitClass='UNITCLASS_GUIDED_MISSILE';
UPDATE Units SET PrereqTech='TECH_ROBOTICS'                 WHERE UnitClass='UNITCLASS_HELICOPTER_GUNSHIP';
UPDATE Units SET PrereqTech='TECH_COMBUSTION'               WHERE UnitClass='UNITCLASS_INFANTRY';
UPDATE Units SET PrereqTech='TECH_ELECTRONICS'              WHERE UnitClass='UNITCLASS_MACHINE_GUN';
UPDATE Units SET PrereqTech='TECH_COMBINED_ARMS'            WHERE UnitClass='UNITCLASS_MARINE';
UPDATE Units SET PrereqTech='TECH_ROBOTICS'                 WHERE UnitClass='UNITCLASS_MECHANIZED_INFANTRY';
UPDATE Units SET PrereqTech='TECH_COMPUTERS'                WHERE UnitClass='UNITCLASS_MISSILE_DESTROYER';
UPDATE Units SET PrereqTech='TECH_PARTICLE_PHYSICS'         WHERE UnitClass='UNITCLASS_NUCLEAR_MISSILE';
UPDATE Units SET PrereqTech='TECH_COMPUTERS'                WHERE UnitClass='UNITCLASS_NUCLEAR_SUBMARINE';
UPDATE Units SET PrereqTech='TECH_COMBINED_ARMS'            WHERE UnitClass='UNITCLASS_PARATROOPER';
UPDATE Units SET PrereqTech='TECH_RADIO'                    WHERE UnitClass='UNITCLASS_SUBMARINE';
UPDATE Units SET PrereqTech='TECH_COMPUTERS'                WHERE UnitClass='UNITCLASS_MOBILE_SAM';
UPDATE Units SET PrereqTech='TECH_SATELLITES'               WHERE UnitClass='UNITCLASS_GUIDED_MISSILE';
UPDATE Units SET PrereqTech='TECH_SATELLITES'               WHERE UnitClass='UNITCLASS_SS_BOOSTER';
UPDATE Units SET PrereqTech='TECH_ADVANCED_BALLISTICS'      WHERE UnitClass='UNITCLASS_SS_ENGINE';
UPDATE Units SET PrereqTech='TECH_PARTICLE_PHYSICS'         WHERE UnitClass='UNITCLASS_SS_COCKPIT';
UPDATE Units SET PrereqTech='TECH_NUCLEAR_FUSION'           WHERE UnitClass='UNITCLASS_XCOM_SQUAD';
