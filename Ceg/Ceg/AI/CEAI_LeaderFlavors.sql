...
-- Personality Types
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   8, 'FLAVOR_MILITARY_TRAINING',        Type FROM Leaders WHERE Personality = 'PERSONALITY_CONQUEROR';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   8, 'FLAVOR_OFFENSE',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_CONQUEROR';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_DEFENSE',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_CONQUEROR';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_CITY_DEFENSE',             Type FROM Leaders WHERE Personality = 'PERSONALITY_CONQUEROR';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   8, 'FLAVOR_SOLDIER',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_CONQUEROR';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   8, 'FLAVOR_MOBILE',                   Type FROM Leaders WHERE Personality = 'PERSONALITY_CONQUEROR';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_ANTI_MOBILE',              Type FROM Leaders WHERE Personality = 'PERSONALITY_CONQUEROR';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_RECON',                    Type FROM Leaders WHERE Personality = 'PERSONALITY_CONQUEROR';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_HEALING',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_CONQUEROR';
...
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   8, 'FLAVOR_MILITARY_TRAINING',        Type FROM Leaders WHERE Personality = 'PERSONALITY_COALITION';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_OFFENSE',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_COALITION';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_DEFENSE',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_COALITION';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_CITY_DEFENSE',             Type FROM Leaders WHERE Personality = 'PERSONALITY_COALITION';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   8, 'FLAVOR_SOLDIER',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_COALITION';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   8, 'FLAVOR_MOBILE',                   Type FROM Leaders WHERE Personality = 'PERSONALITY_COALITION';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_ANTI_MOBILE',              Type FROM Leaders WHERE Personality = 'PERSONALITY_COALITION';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_RECON',                    Type FROM Leaders WHERE Personality = 'PERSONALITY_COALITION';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_HEALING',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_COALITION';
...
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_MILITARY_TRAINING',        Type FROM Leaders WHERE Personality = 'PERSONALITY_DIPLOMAT';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_OFFENSE',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_DIPLOMAT';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_DEFENSE',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_DIPLOMAT';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_CITY_DEFENSE',             Type FROM Leaders WHERE Personality = 'PERSONALITY_DIPLOMAT';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_SOLDIER',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_DIPLOMAT';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_MOBILE',                   Type FROM Leaders WHERE Personality = 'PERSONALITY_DIPLOMAT';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_ANTI_MOBILE',              Type FROM Leaders WHERE Personality = 'PERSONALITY_DIPLOMAT';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_RECON',                    Type FROM Leaders WHERE Personality = 'PERSONALITY_DIPLOMAT';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_HEALING',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_DIPLOMAT';
...
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_MILITARY_TRAINING',        Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_OFFENSE',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_DEFENSE',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_CITY_DEFENSE',             Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_SOLDIER',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_MOBILE',                   Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_ANTI_MOBILE',              Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   2, 'FLAVOR_RECON',                    Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
INSERT OR REPLACE INTO Leader_Flavors(FlavorType, LeaderType, Flavor) SELECT   4, 'FLAVOR_HEALING',                  Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
